...
export enum I18nKey {
  ...
  SETTINGS$NAV_AGENT_TYPE = "SETTINGS$NAV_AGENT_TYPE",
  SETTINGS$NAV_ACP_SERVER = "SETTINGS$NAV_ACP_SERVER",
  SETTINGS$NAV_ACP_MODEL = "SETTINGS$NAV_ACP_MODEL",
  SETTINGS$AGENT_TYPE_TITLE = "SETTINGS$AGENT_TYPE_TITLE",
  ...
  SETTINGS$AGENT_TYPE_OPENHANDS_DESCRIPTION = "SETTINGS$AGENT_TYPE_OPENHANDS_DESCRIPTION",
  SETTINGS$AGENT_TYPE_ACP_DESCRIPTION = "SETTINGS$AGENT_TYPE_ACP_DESCRIPTION",
  SETTINGS$LLM_ACP_ACTIVE_NOTICE = "SETTINGS$LLM_ACP_ACTIVE_NOTICE",
  ...
  ACP_TOOL_CALL$IN_PROGRESS = "ACP_TOOL_CALL$IN_PROGRESS",
  ACP_TOOL_CALL$COMPLETED = "ACP_TOOL_CALL$COMPLETED",
  ACP_TOOL_CALL$FAILED = "ACP_TOOL_CALL$FAILED",
  ACP_TOOL_CALL$INPUT = "ACP_TOOL_CALL$INPUT",
  ACP_TOOL_CALL$OUTPUT = "ACP_TOOL_CALL$OUTPUT",
  ACP_TOOL_CALL$NO_INPUT = "ACP_TOOL_CALL$NO_INPUT",
  ACP_TOOL_CALL$NO_OUTPUT = "ACP_TOOL_CALL$NO_OUTPUT",
  ACP_TOOL_CALL$TRUNCATED = "ACP_TOOL_CALL$TRUNCATED",
