...
export enum I18nKey {
  ...
  SETTINGS$AGENT_PAGE_TITLE = "SETTINGS$AGENT_PAGE_TITLE",
  SETTINGS$AGENT_PAGE_DESCRIPTION = "SETTINGS$AGENT_PAGE_DESCRIPTION",
  SETTINGS$AGENT_TYPE_LABEL = "SETTINGS$AGENT_TYPE_LABEL",
  SETTINGS$AGENT_TYPE_OPENHANDS = "SETTINGS$AGENT_TYPE_OPENHANDS",
  SETTINGS$AGENT_TYPE_CLAUDE_CODE = "SETTINGS$AGENT_TYPE_CLAUDE_CODE",
  SETTINGS$AGENT_TYPE_CODEX = "SETTINGS$AGENT_TYPE_CODEX",
  SETTINGS$AGENT_TYPE_GEMINI_CLI = "SETTINGS$AGENT_TYPE_GEMINI_CLI",
  SETTINGS$AGENT_API_KEY_LABEL = "SETTINGS$AGENT_API_KEY_LABEL",
  SETTINGS$AGENT_API_KEY_SET = "SETTINGS$AGENT_API_KEY_SET",
  SETTINGS$AGENT_ADVANCED_COMMAND = "SETTINGS$AGENT_ADVANCED_COMMAND",
  SETTINGS$AGENT_ADVANCED_COMMAND_PLACEHOLDER = "SETTINGS$AGENT_ADVANCED_COMMAND_PLACEHOLDER",
  SETTINGS$AGENT_ADVANCED_ARGS = "SETTINGS$AGENT_ADVANCED_ARGS",
  SETTINGS$AGENT_ADVANCED_ARGS_PLACEHOLDER = "SETTINGS$AGENT_ADVANCED_ARGS_PLACEHOLDER",
  SETTINGS$AGENT_ADVANCED_ENV = "SETTINGS$AGENT_ADVANCED_ENV",
  SETTINGS$AGENT_ADVANCED_ENV_PLACEHOLDER = "SETTINGS$AGENT_ADVANCED_ENV_PLACEHOLDER",
  SETTINGS$AGENT_DISABLED_TOOLTIP = "SETTINGS$AGENT_DISABLED_TOOLTIP",
  SETTINGS$AGENT_SAVE = "SETTINGS$AGENT_SAVE",
  SETTINGS$AGENT_SAVING = "SETTINGS$AGENT_SAVING",
  SETTINGS$AGENT_SAVED = "SETTINGS$AGENT_SAVED",
  SETTINGS$AGENT_BASIC_TAB = "SETTINGS$AGENT_BASIC_TAB",
  SETTINGS$AGENT_ADVANCED_TAB = "SETTINGS$AGENT_ADVANCED_TAB",
  SETTINGS$AGENT_INCOMPATIBLE_CONVERSATION = "SETTINGS$AGENT_INCOMPATIBLE_CONVERSATION",
  SETTINGS$AGENT_INCOMPATIBLE_CHANGE = "SETTINGS$AGENT_INCOMPATIBLE_CHANGE",
  SETTINGS$AGENT_ADVANCED_COMMAND_HINT = "SETTINGS$AGENT_ADVANCED_COMMAND_HINT",
  SETTINGS$AGENT_ADVANCED_ARGS_HINT = "SETTINGS$AGENT_ADVANCED_ARGS_HINT",
  SETTINGS$AGENT_ENV_MUST_BE_OBJECT = "SETTINGS$AGENT_ENV_MUST_BE_OBJECT",
  SETTINGS$AGENT_ENV_VALUES_MUST_BE_STRINGS = "SETTINGS$AGENT_ENV_VALUES_MUST_BE_STRINGS",
}
